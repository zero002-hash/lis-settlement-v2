        ...
        return new Promise((resolve, reject) => {
            transition.ready
                ...
                cropRadii.forEach((radii, name) => {
                    ...
                    radiusOptions.duration && (radiusOptions.duration = motionUtils.secondsToMilliseconds(radiusOptions.duration));
                    radiusOptions.delay && (radiusOptions.delay = motionUtils.secondsToMilliseconds(radiusOptions.delay));
                    for (const corner of cornerProps) {
