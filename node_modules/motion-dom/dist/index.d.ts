...
import { Point, BoundingBox, Axis, Box, TransformPoint, Easing, Delta, EasingFunction, BezierDefinition, AxisDelta, SubscriptionManager } from 'motion-utils';
...
declare function createAnimationState(visualElement: any): AnimationState$1;
 ...
 */
declare function arc(options?: ArcOptions): MotionPath;
...
declare function recordStats(): void;

interface LayoutProjectionMetrics {
    nodes: number;
    calculatedTargetDeltas: number;
    calculatedProjections: number;
}
interface LayoutProjectionStats {
    nodes: number[];
    calculatedTargetDeltas: number[];
    calculatedProjections: number[];
}
...
declare class ViewTransitionBuilder {
     ...
     */
    pairs: Map<ViewTransitionTargetDefinition, ViewTransitionTargetDefinition>;
    /**
     ...
     */
    classNames: Map<ViewTransitionTargetDefinition, string>;
    update: () => void | Promise<void>;
    options: ViewTransitionOptions;
    notifyReady: (value: GroupAnimation) => void;
    notifyReject: (error: unknown) => void;
     ...
     */
    add(subject: ViewTransitionTargetDefinition, newSubject?: ViewTransitionTargetDefinition): this;
    /**
...
declare function animateView(update: () => void | Promise<void>, options?: ViewTransitionOptions): ViewTransitionBuilder;
...
interface IProjectionNode<I = unknown> {
    ...
    setAnimationOrigin(delta: Delta, hasOnlyRelativeTargetChanged?: boolean, pathFn?: MotionPath): void;
...
declare const DocumentProjectionNode: {
    new (latestValues?: ResolvedValues$1, parent?: IProjectionNode<unknown> | undefined): {
        ...
        mixTargetDelta: (progress: number) => void;
        animationProgress: number;
        setAnimationOrigin(delta: motion_utils.Delta, hasOnlyRelativeTargetChanged?: boolean, pathFn?: MotionPath | undefined): void;
        motionValue?: MotionValue<number> | undefined;
        startAnimation(options: ValueAnimationOptions<number>): void;
        completeAnimation(): void;
        finishAnimation(): void;
...
declare class LayoutAnimationBuilder {
    ...
    private updateError;
    constructor(scope: LayoutAnimationScope, updateDom: () => void | Promise<void>, defaultOptions?: AnimationOptions | undefined);
    ...
    adopt(element: HTMLElement, node: IProjectionNode): void;
    collectTargets(): HTMLElement[];
    runUpdate(): Promise<void> | undefined;
    reconcileAdditions(newMemberIds: Set<string>): void;
    reconcileRemovals(newMemberIds: Set<string>): void;
